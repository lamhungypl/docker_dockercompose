...
<head>
    ...
    <title>Martplace - Sinlge Products Goes Here</title>
                    ...
                    <div class="item-preview">
                        <div class="item__preview-slider">
                            ...
                            <div class="prev-slide">
                                <img style='width:750px;height:430px;object-fit: cover;' src="assests/product_images/earphone/earphone_12.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                            </div>
                        </div>
                            ...
                            <div class="prev-thumb">
                                <div class="thumb-slider">
                                    <div class="item-thumb">
                                        <img src="assests/product_images/earphone/earphone_12.jpg" style='width:80px;height:80px;object-fit: cover;' alt="This is the thumbnail of the item">
                                    </div>

                                    <div class="item-thumb">
                                        <img src="assests/product_images/earphone/earphone_2.jpg" style='width:80px;height:80px;object-fit: cover;' alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="assests/product_images/earphone/earphone_10.jpg" style='width:80px;height:80px;object-fit: cover;' alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="assests/product_images/earphone/earphone_8.jpg" style='width:80px;height:80px;object-fit: cover;' alt="This is the thumbnail of the item">
                                    </div>
                                    <div class="item-thumb">
                                        <img src="assests/product_images/earphone/earphone_6.jpg" style='width:80px;height:80px;object-fit: cover;' alt="This is the thumbnail of the item">
                                    </div>
                                </div>
                                <!-- end /.thumb-slider -->
